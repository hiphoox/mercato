...
- [settings/](settings/index.md) — The platform-wide values an operator tunes to fit what their marketplace sells.
- [users/](users/index.md) — User accounts and the RBAC role/permission model.

`data-architecture.md` in `docs/architecture/` already references an `entities.md` in this section; it does not exist yet and is a known gap.
