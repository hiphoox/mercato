...
- [discovery-facets.md](discovery-facets.md) — How the browse grid's filters are declared once and drive both the query and the controls. Read it when working on browsing, filtering, or the filter bar.
