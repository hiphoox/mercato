...
The Phase 1 MVP is "list an item, find it, buy it" — *buy it* is this file, *list it* is the listings backlog, and *find it* is [discovery/](../discovery/todo.md). None of the three is shippable alone.
