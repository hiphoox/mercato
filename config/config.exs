...
# The values a marketplace tunes — its currency, the conditions a seller may
# pick from, what a gallery accepts and how much of it, and how long a cart
# keeps an untouched line — are not configured here. They live on the single
# settings row an operator edits from the admin area; see
# `Mercato.Accounts.Setting` for the platform defaults that apply until one
# does.
